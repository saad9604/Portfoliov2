          ...
          <div className="lg:flex-row flex flex-col lg:justify-between lg:pt-16">
            ...
            <motion.div
              ...
              <div className="flex lg:gap-5 gap-3 mx-auto lg:mx-0 lg:h-[50px] h-[40px] mt-10 mb-9 -translate-x-3">
                  <motion.img
                    animate={{ rotate: 360, scale:1.01}}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={html} className="shadow-md shadow-black rounded-full p-1" alt="HTML" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={css} className="shadow-md shadow-black rounded-full p-1" alt="CSS" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={javascript} className="shadow-md shadow-black rounded-full p-1" alt="JavaScript" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={react} className="shadow-md shadow-black rounded-full p-1" alt="React" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={mongodb} className="shadow-md shadow-black rounded-full p-1" alt="MongoDB" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={node} className="shadow-md shadow-black rounded-full p-1" alt="Node.js" />
                  <motion.img
                    animate={{ rotate: 360, scale: 1.01 }}
                    transition={{ duration: 3, repeat: Infinity }}
                    src={prisma} className="shadow-md shadow-black rounded-full p-1" alt="Prisma" />
               </div>
